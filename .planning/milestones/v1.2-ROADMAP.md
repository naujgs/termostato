...
**Success Criteria** (what must be TRUE):
  1. User can see CoreWatch's own CPU usage displayed as a percentage, updating on the polling interval
  2. User can see CoreWatch's own memory footprint displayed in MB, updating on the polling interval
