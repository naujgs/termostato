...
Reviewed the single changed file `TemperatureViewModel.swift`, which is the core MVVM data pipeline for CoreWatch. The file implements thermal state polling, session history ring buffer management, background task handling, and local notification delivery.
...
**File:** `CoreWatch/CoreWatch/TemperatureViewModel.swift:113`
...
**File:** `CoreWatch/CoreWatch/TemperatureViewModel.swift:210-214` and `236`
...
**File:** `CoreWatch/CoreWatch/TemperatureViewModel.swift:129-135`
...
**File:** `CoreWatch/CoreWatch/TemperatureViewModel.swift:111`
