...
**File:** `CoreWatch/CoreWatch/ContentView.swift:123-137`
...
**File:** `CoreWatch/CoreWatch/TemperatureViewModel.swift:205-224`
...
**File:** `CoreWatch/CoreWatch/TemperatureViewModel.swift:262`
...
do {
    ...
    print("[CoreWatch] Failed to schedule notification: \(error)")
}
```

### IN-02: requestNotificationPermission Called on Every Foreground

**File:** `CoreWatch/CoreWatch/TemperatureViewModel.swift:118`
...
### IN-03: @State Used for Non-Observable Reference Type in CoreWatchApp

**File:** `CoreWatch/CoreWatch/CoreWatchApp.swift:9`
